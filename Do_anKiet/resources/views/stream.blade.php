...
<body>
    ...
    <header class="
      ...
      ">
        ...
        >
        <a class="d-flex align-items-center text-secondary" href="{{route('people')}}">People</a>
        </nav>
    </header>
    ...
    <main class="container">
        ...
        @forelse($dsLop as $gv)
        @dd("$gv")
            <h1 class="banner__class">{{$gv->ten_lop}}</h1>
            <div class="fs-4">
                <span>Teacher: </span
          ><span class="banner__teacher">{{$user->ho_ten}}</span>
            </div>
            <div class="fs-4">
                <span>Subject: </span
          ><span class="banner__subject">{{$gv->thong_tin}}</span>
            </div>
            <div class="fs-4">
                <span>Room: </span><span class="banner__room">{{$gv->code}}</span>
            </div>
            @empty
        @endforelse
        </section>
