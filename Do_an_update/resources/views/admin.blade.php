                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>{{$gv->updated_at}}</td>
                        <td>
                        <a href="{{route('xoa_tai_khoan',['id'=>$gv->id])}};" onclick="return confirm('Bạn Thật sự muốn xóa?');"class="btn btn-xs btn-danger btn-delete">Delete</a>
                        </td>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                        <div class="btn-group">
                        <a href="{{route('khoi_phuc_tai_khoan',['id'=>$gv->id])}};" onclick="return confirm('Bạn muốn khôi phục có tài khoản này?');"class="btn btn-xs btn-btn-success btn-success">Restore</a>
                        <a href="{{route('xoa_vinh_vien_tai_khoan',['id'=>$gv->id])}};" onclick="return confirm('Bạn muốn bạn có muốn xóa vĩnh viễn này?');"class="btn btn-xs btn-btn-danger btn-danger">Permanently deleted</a>
                        </div>
                        </td>
                      </tr>
              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>{{$hv->updated_at}}</td>
                    <td>
                    <a href="{{route('xoa_tai_khoan',['id'=>$hv->id])}};" onclick="return confirm('Bạn Thật sự muốn xóa?');"class="btn btn-xs btn-danger btn-delete">Delete</a>
              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                    <div class="btn-group">
                    <a href="{{route('khoi_phuc_tai_khoan',['id'=>$hv->id])}};" onclick="return confirm('Bạn muốn khôi phục có tài khoản này?');"class="btn btn-xs btn-btn-success btn-success">Restore</a>
                    <a href="{{route('xoa_vinh_vien_tai_khoan',['id'=>$hv->id])}};" onclick="return confirm('Bạn muốn bạn có muốn xóa vĩnh viễn này?');"class="btn btn-xs btn-btn-danger btn-danger">Permanently deleted</a>
                    </div>
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                  <a href="{{route('xoa_lop',['id'=>$lop->id])}};" onclick="return confirm('Bạn Thật sự muốn xóa?');"class="btn btn-xs btn-danger btn-delete">Delete</a>
                  </td>
                </tr>
                @empty
                <tr>
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                  <div class="btn-group">
                    <a href="{{route('khoi_phuc_lop',['id'=>$lop->id])}};" onclick="return confirm('Bạn muốn khôi phục  lớp này?');"class="btn btn-xs btn-success ">Restore</a>
                    <a href="{{route('xoa_vinh_vien_lop',['id'=>$lop->id])}};" onclick="return confirm('Bạn muốn xóa vĩnh viễn lớp này?');"class="btn btn-xs btn-danger ">Permanently deleted </a>
                  </div>
                  </td>
                </tr>
                @empty
