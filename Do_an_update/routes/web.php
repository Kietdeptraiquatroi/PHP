...
Route::get('/stream/hv/{id}',[HocSinhController::class,'thongtinstreamLop'])->name('tt_stream_hv');
Route::get('/stream/gv/{id}',[GiaoVienController::class,'thongtinstreamLop'])->name('tt_stream_gv');
