                ...
                <div class="d-flex flex-column h-100">
                    <img src="{{$gv->background}}" class="img-cover h-50" alt="Card background" />
                              <div class="class-card__body my-2">
                                ...
                                <form action="{{route('tt_stream',['id'=>$gv->id])}}">
                                
                                <button class="btn btn-primary mt-auto py-2">Go to Class</button>
                                </form>
                                <div>
                        <a href="{{route('xoa_lop',['id'=>$gv->id])}};" onclick="return confirm('Bạn Thật sự muốn xóa?');"class="btn btn-xs btn-danger btn-delete">Delete</a>
