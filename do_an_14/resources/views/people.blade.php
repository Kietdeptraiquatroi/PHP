...
<html lang="en">
    ...
    <body>
        ...
        <section class="container mt-4 border py-4 bg-white">
            ...
            <form class="d-flex gap-2 mb-4 border-bottom pb-3" action="{{route('gui_vao_lop')}}" >
            ...
            @if($lop->pivot->deleted_at!=NULL)
                ...
                @empty
              <tr>
                  <td colspan="5">Không học viên nào</td>
              </tr>
              @endforelse
            ...
            @if($lop->pivot->deleted_at==NULL)
                ...
                <li class="d-flex align-items-center justify-content-between">
                    ...
                    <form action="{{route('kich_hoc_vien',['id'=>$lop->pivot->id])}}">
                               <button class="btn btn-danger">Loại ra khỏi lớp lớp</button>
                        </form>   
                    </div>
                </li>
                @endif
