                            ...
                            <div class="d-flex flex-column h-100">
                              ...
                              />
                                      <div class="class-card__body my-2">
                                        ...
                                        <div class="btn-group">
                                        <form action="{{route('tt_stream_hv',['id'=>$tk->id])}}">
                        <button class="btn btn-primary mt-auto py-2">Vào lớp</button>
                        </form>
                        <a href="{{route('roi_lop',['id'=>$tk->pivot->id])}}" onclick="return confirm('Bạn thật sự muốn rời lớp này?');"class="btn btn-xs btn-danger btn-delete">Rời lớp</a>
                        </div>
                        </div>
              </div>
